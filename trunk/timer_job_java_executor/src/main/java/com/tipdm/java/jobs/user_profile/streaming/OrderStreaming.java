package com.tipdm.java.jobs.user_profile.streaming;
...
public class OrderStreaming implements JavaJobInterface {
    ...
    private static String  sparkClassName="com.tipdm.scala.chapter_3_7_streaming.KafkaStream";
    private static  String applicationName = "KafkaStream";
    public static void main(String[] args) throws Exception {
        String className = "com.tipdm.java.jobs.user_profile.streaming.OrderStreaming";
