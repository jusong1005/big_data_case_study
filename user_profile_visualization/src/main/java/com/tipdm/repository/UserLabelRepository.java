 ...
 */
public interface UserLabelRepository extends BaseReporitory<CustomerUnLabel, UserLabel> {
    ...
    @Query(value = "select phone_no from user_label where phone_no is not null limit 10", nativeQuery = true)
