var userLabel = echarts.init(document.getElementById('userLabel'));
var userLabel_option = {
	series: [{
		type: 'graph',
		name: "用户标签",
		layout: 'force',
...
userLabel.setOption(userLabel_option);
